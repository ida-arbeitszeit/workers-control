...
class GeneralUrlIndex:
    ...
    def get_plan_review_url(self, plan_id: UUID) -> str:
        return url_for("main_accountant.review_plan", plan_id=plan_id)
    ...
    def get_change_user_name_url(self) -> str:
        return url_for("main_user.change_user_name")
    ...
    def get_my_basic_services_url(self) -> str:
        return url_for("main_member.basic_services")
