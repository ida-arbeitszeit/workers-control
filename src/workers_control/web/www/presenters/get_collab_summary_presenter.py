...
class AssociatedPlan:
    ...
    planner_name: str
    planner_url: str
    show_end_collab_button: bool


@dataclass
class GetCollabSummaryViewModel:
    collab_id: str
    collab_name: str
...
@dataclass
class GetCollabSummarySuccessPresenter:
    url_index: UrlIndex
        ...
        return GetCollabSummaryViewModel(
            ...
            plans=[
                AssociatedPlan(
                    ...
                    show_end_collab_button=response.requester_is_coordinator
