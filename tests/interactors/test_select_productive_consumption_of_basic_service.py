...
class InteractorTests(BaseTestCase):
    def setUp(self) -> None:
        ...
        self.interactor = self.injector.get(
            select_productive_consumption_of_basic_service.SelectProductiveConsumptionOfBasicServiceInteractor
        )
    ...
    def test_no_basic_service_response_when_no_id_provided(self) -> None:
        ...
        assert isinstance(
            response,
            select_productive_consumption_of_basic_service.NoBasicServiceResponse,
        )
    ...
    def test_invalid_basic_service_response_when_id_does_not_exist(self) -> None:
        ...
        assert isinstance(
            response,
            select_productive_consumption_of_basic_service.InvalidBasicServiceResponse,
        )
    ...
    def test_valid_basic_service_response_when_id_exists(self) -> None:
        ...
        assert isinstance(
            response,
            select_productive_consumption_of_basic_service.ValidBasicServiceResponse,
        )
    ...
    ) -> select_productive_consumption_of_basic_service.Request:
        return select_productive_consumption_of_basic_service.Request(
