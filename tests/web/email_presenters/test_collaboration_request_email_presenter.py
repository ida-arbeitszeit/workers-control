...
from workers_control.web.email.collaboration_request_email_presenter import (
    CollaborationRequestEmailPresenter,
)


class CollaborationRequestEmailPresenterTests(BaseTestCase):
    def setUp(self) -> None:
        super().setUp()
        self.presenter = self.injector.get(CollaborationRequestEmailPresenter)
