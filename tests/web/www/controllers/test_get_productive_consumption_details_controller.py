...
class ControllerTests(BaseTestCase):
    def setUp(self) -> None:
        super().setUp()
        self.controller = self.injector.get(GetProductiveConsumptionDetailsController)
    ...
    def test_request_contains_logged_in_company_id(self) -> None:
        ...
        assert request.company == expected_company_id
