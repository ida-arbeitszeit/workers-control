...
class UrlIndexTestImpl:
    ...
    get_company_consumptions_url = UrlIndexMethod()
    get_company_consumption_details_url = UrlIndexMethod()
    get_company_dashboard_url = UrlIndexMethod()
    get_company_summary_url = UrlIndexMethod()
    get_collab_summary_url = UrlIndexMethod()
    ...
    get_my_collaborations_url = UrlIndexMethod()
    ...
    get_plan_review_url = UrlIndexMethod()
    ...
    get_request_collab_url = UrlIndexMethod()
    ...
    get_start_page_url = UrlIndexMethod()
    ...
    get_my_basic_services_url = UrlIndexMethod()
